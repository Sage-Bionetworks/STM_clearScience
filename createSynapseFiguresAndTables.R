...
fig1File <- File(fig1, synapseStoreParam=TRUE, parentId=synFigFolderId)
...
fig2File <- File(fig2, synapseStoreParam=TRUE, parentId=synFigFolderId)
...
fig3File <- File(fig3, synapseStoreParam=TRUE, parentId=synFigFolderId)
...
fig4File <- File(fig4, synapseStoreParam=TRUE, parentId=synFigFolderId)
...
table1aFile <- File(table1$inducing, synapseStoreParam=TRUE, parentId=synTableFolderId)
generatedBy(table1aFile) <- table1Activity
table1aFile <- storeEntity(table1aFile)
table1Activity <- generatedBy(table1aFile)

table1bFile <- File(table1$protective, synapseStoreParam=TRUE, parentId=synTableFolderId)
